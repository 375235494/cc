...
@implementation HMDataDropdownMenu
{
...
- (void)createMainBtnWithFrame:(CGRect)frame{
    ...
    [_mainBtn setTitle:DateTime forState:UIControlStateNormal];
    ...
    _arrowMark.image  = [UIImage imageNamed:@""];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(detaDropdownMenu:selectedCellNumber:)]) {
        [self.delegate detaDropdownMenu:self selectedCellNumber:indexPath.row]; // 回调代理
    }
