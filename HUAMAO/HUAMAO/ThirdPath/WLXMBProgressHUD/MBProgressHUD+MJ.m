...
+ (void)showMsg:(NSString *)msg toView:(UIView *)view
{
    ...
    MBProgressHUD *hud = [MBProgressHUD showHUDAddedTo:view animated:YES];
    hud.labelText = msg;
    hud.labelColor = [UIColor colorWithRed:253/255.0 green:208/255.0 blue:0.0 alpha:1.0];
    hud.color = [UIColor colorWithRed:51/255.0 green:51/255.0 blue:51/255.0 alpha:0.8];
    // 设置图片
...
+(MBProgressHUD *)wlxMBShowMessage:(NSString*)msg
{
